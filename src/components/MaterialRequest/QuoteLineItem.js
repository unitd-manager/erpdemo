                    ...
                    <table className="lineitem">
                      <thead>
                        <tr>
                          ...
                          <th scope="col">{arabic.find((item) => item.key_text === 'mdMaterialRequest.Amount')?.[genLabel]}</th>
                          <th scope="col">{arabic.find((item) => item.key_text === 'mdMaterialRequest.Remarks')?.[genLabel]}</th>
                          <th scope="col"></th>
                        </tr>
                      </thead>
                      <tbody>
