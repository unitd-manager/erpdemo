...
export default function JobOrderAttachment() {
    JobOrderAttachment.propTypes = {
    }
    const { id } = useParams();
  ...
  <AttachmentModalV2
    ...
    setUpdate={setUpdate}
  />
  <ViewFileComponentV2 moduleId={id} roomName="ProjectJobOrder" recordType="RelatedPicture" update={update}
